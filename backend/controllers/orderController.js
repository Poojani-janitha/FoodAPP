...
const placeOrder = async (req, res) => {
    ...
    try {
        ...
        // If Stripe is not available, return order ID without payment session
        if (!stripe) {
            return res.json({ 
                success: true, 
                message: "Order placed successfully (Payment integration not configured)",
